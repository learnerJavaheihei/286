...
public class EnchantResultPacket extends L2GameServerPacket
{
	...
	//public static final EnchantResultPacket SUCESS = new EnchantResultPacket(0, 0, 0, 0, 0); // вещь заточилась, в статичном виде не используется
	...
	public EnchantResultPacket(int resultId, int crystalId, long count, int enchantLevel,int enchantLevel2)
	{
		_resultId = resultId;
