...
public class ExBR_PresentBuyProductPacket extends L2GameServerPacket
{
	...
	public static final L2GameServerPacket RESULT_ITEM_LIMITED = new ExBR_PresentBuyProductPacket(-28);	// При покупке количество этих предметов на один аккаунт ограничено. Куплено максимальное количество, больше купить нельзя.
