...
public class RequestOustAlly extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(clan != null)
		{
			...
			//activeChar.sendMessage(new CustomMessage("l2s.gameserver.network.l2.c2s.RequestOustAlly.ClanDismissed").addString(clan.getName()).addString(alliance.getAllyName()));
		}
	}
}