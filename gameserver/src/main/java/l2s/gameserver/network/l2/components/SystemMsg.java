...
public enum SystemMsg implements IBroadcastPacket
{
	...
	MACRO_USE_ONLY(5270),
	// Message: You must level 70 or higher and have completed the 2nd Class Transfer in order to participate in a match.
	...
	// Message: Cannot apply to participate because your inventory slots or weight exceeded 80%%.
	...
	// Message: Transformation, evolution, and extraction are not available during private store or workshop use.
	...
	// Message: Transformation, evolution, and extraction are not available in the freeze state.
	...
	// Message: Transformation, evolution, and extraction are not available during exchange.
	TRANSFORMATION_EVOLUTION_AND_EXTRACTION_ARE_NOT_AVAILABLE_DURING_EXCHANGE(6851),
	// Message: Transformation, evolution, and extraction are not available in the petrification state.
	TRANSFORMATION_EVOLUTION_AND_EXTRACTION_ARE_NOT_AVAILABLE_IN_THE_PETRIFICATION_STATE(6852),
	// Message: Transformation, evolution, and extraction are not available during fishing.
	TRANSFORMATION_EVOLUTION_AND_EXTRACTION_ARE_NOT_AVAILABLE_DURING_FISHING(6853),
	// Message: You cannot use transformation, evolution, and  extraction while sitting.
	...
	// Message: Transformation, evolution, and extraction are not available in a fight.
	...
	// Message: Evolution of transformation is not available at the moment. Try again later.
	...
	// Message: Only characters of level 70 or higher who have completed the 2nd class transfer can use this command.
	...
	// Message: You will exceed the max amount of time for the hunting zone, so you cannot add any more time.
	YOU_WILL_EXCEED_THE_MAX_AMOUNT_OF_TIME_FOR_THE_HUNTING_ZONE_SO_YOU_CANNOT_ADD_ANY_MORE_TIME(13015),
	// Message: The time for hunting in this zone expires in $s1 min. Please add more time.
	THE_TIME_FOR_HUNTING_IN_THIS_ZONE_EXPIRES_IN_S1_MIN_PLEASE_ADD_MORE_TIME(13016),
	// Message: Special instance zones cannot be used while waiting for the Olympiad.
	...
	// Message: The character is in a location where it is impossible to use this function.
