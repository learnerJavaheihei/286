...
public class AdminAttributes implements IAdminCommandHandler
{
	...
	public void showMainPage(Player activeChar)
	{
		...
		replyMSG.append("<button value=\"頭盔\" action=\"bypass -h admin_setatteh $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"頭飾\" action=\"bypass -h admin_setattha $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"頭飾\" action=\"bypass -h admin_setattdha $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"L-手鐲\" action=\"bypass -h admin_setattlbr $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"項鏈\" action=\"bypass -h admin_setatten $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td></tr></table>");
		replyMSG.append("</center><center><table width=270><tr><td>");
		replyMSG.append("<button value=\"武器\" action=\"bypass -h admin_setattew $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"胸針\" action=\"bypass -h admin_setattec $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"盾牌\" action=\"bypass -h admin_setattes $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"耳環\" action=\"bypass -h admin_setattre $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"耳環\" action=\"bypass -h admin_setattle $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td></tr></table>");
		replyMSG.append("</center><center><table width=270><tr><td>");
		replyMSG.append("<button value=\"手套\" action=\"bypass -h admin_setatteg $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"褲子\" action=\"bypass -h admin_setattel $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"鞋子\" action=\"bypass -h admin_setstteb $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"耳環\" action=\"bypass -h admin_setattrf $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"耳環\" action=\"bypass -h admin_setattlf $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td></tr></table>");
		replyMSG.append("</center><center><table width=270><tr><td>");
		replyMSG.append("<button value=\"腰帶\" action=\"bypass -h admin_setattbelt $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td></tr></table>");
