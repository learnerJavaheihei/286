...
public final class ItemInstance extends GameObject implements JdbcEntity
{
	...
	{
		/* if (!getTemplate().isHairAccessory() && !getTemplate().isCloak())//修复后的斗篷
	...
	private static final int[][] ENCHANT_FAIL_WEAPON_STONES = new int[][]{
			{ 0 },  // NONE
			{ 0, 0, 0, 0, 0, 1, 1, 2, 3, 4, 6, 8, 9, 11, 12, 14, 15, 17, 18, 21 }, // D  *1.5
			{ 0, 0, 0, 0, 1, 2, 2, 3, 4, 6, 11, 12, 14, 18, 20, 21, 26, 27, 29, 38 },  // C  *1.5
			{ 0, 0, 0, 1, 2, 2, 4, 6, 8, 10, 16, 18, 20, 26, 28, 30, 36, 38, 40, 56 }, // B  *2
			{ 0, 0, 0, 2, 5, 8, 10, 12, 15, 18, 30, 33, 35, 48, 50, 53, 65, 68, 70, 95 },   // A *2.5
			{ 0, 0, 0, 5, 8, 10, 15, 38, 45, 53, 63, 70, 73, 75, 78, 80, 83, 85, 88, 90 } // S *2.5
	};

	private static final int[][] ENCHANT_FAIL_ARMOR_STONES = new int[][]{
			{ 0 },  // NONE
			{ 0, 0, 0, 0, 1, 1, 2, 3, 5, 8, 9, 11, 18 }, // D
			{ 0, 0, 0, 1, 2, 2, 3, 4, 6, 11, 12, 14, 23 }, // C
			{ 0, 0, 0, 2, 2, 4, 6, 8, 10, 18, 20, 22, 38 },   // B
			{ 0, 0, 0, 2, 5, 8, 12, 15, 18, 33, 35, 40, 65 },  // A
			{ 0, 0, 0, 5, 8, 10, 25, 38, 50, 63, 68, 70, 75 }    // S
	};
