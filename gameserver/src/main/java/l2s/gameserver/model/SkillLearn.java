...
public final class SkillLearn implements Comparable<SkillLearn>
{
	...
	private final List<ItemData> _additionalRequiredItems = new ArrayList<ItemData>(); // На данные итемы (книги) не влияет конфиг на отключение необходимости книг.
	private final List<ItemData> _allRequiredItems = new ArrayList<ItemData>(); // Все требуемые итемы (книги).
