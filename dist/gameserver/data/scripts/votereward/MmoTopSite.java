...
public class MmoTopSite extends AbstractAutoRewardSite {
	...
	protected void parseVotes(Map<String, List<IntIntPair>> votesCache) {
		String serverResponse = VoteApiService.getApiResponse(String.format("https://mmotop.ru/votes/%s", serverVotesLink));
		if (serverResponse != null) {
			...
			while (m.find()) {
				...
				votes.add(new IntIntPairImpl((int) (voteDate.getTime() / 1000), Integer.parseInt(m.group(5))));
			}
		}
	}
}