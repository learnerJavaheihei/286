 ...
 * @author Bonux
 **/
public class HuntWindMonsters extends ProgressDailyMissionHandler {
	private class HandlerListeners implements OnKillListener {
		@Override
		public void onKill(Creature actor, Creature victim) {
			Player player = actor.getPlayer();
			if (player != null && player.getActiveElement() == ElementalElement.FIRE) {
				if (victim.isMonster() && victim.getActiveElement() == ElementalElement.WIND)
