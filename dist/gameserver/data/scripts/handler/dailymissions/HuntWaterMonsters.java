 ...
 * @author Bonux
 **/
public class HuntWaterMonsters extends ProgressDailyMissionHandler {
	private class HandlerListeners implements OnKillListener {
		@Override
		public void onKill(Creature actor, Creature victim) {
			Player player = actor.getPlayer();
			if (player != null && player.getActiveElement() == ElementalElement.EARTH) {
				if (victim.isMonster() && victim.getActiveElement() == ElementalElement.WATER)
