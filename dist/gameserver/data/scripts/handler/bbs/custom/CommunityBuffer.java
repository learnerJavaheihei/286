...
public class CommunityBuffer extends CustomCommunityHandler
{
	...
	protected void doBypassCommand(Player player, String bypass)
	{
		...
		if(bypass.startsWith("_cbbsbuffer"))
		{
			...
			{
				player.sendMessage(player.isLangRus() ? "Эта функция недоступна во время Фестиваля Хаоса." : "This feature is not available at the Chaos Festival.");
				player.sendPacket(ShowBoardPacket.CLOSE);
				return;
			}*/
	...
	private static String pageList(Player player, String[] var)
	{
		...
		for(int i = pageIdx * pageMax; i < buffSetSkills.size(); )
		{
			...
			if(player.isLangRus())
				buff_str += "<td fixwidth=\"165\"><table width=\"160\" border=\"0\"><tr><td width=\"160\">" + makeNameBlock(player, buffSkill) + "</td></tr><tr><td width=\"160\"><font color=\"LEVEL\">Уровень " + buffSkill.getSkill().getLevel() + "</font></td></tr></table></td>";
			else
				buff_str += "<td fixwidth=\"165\"><table width=\"160\" border=\"0\"><tr><td width=\"160\">" + makeNameBlock(player, buffSkill) + "</td></tr><tr><td width=\"160\"><font color=\"LEVEL\">Level " + buffSkill.getSkill().getLevel() + "</font></td></tr></table></td>";
